  ...
  {  
    ...
    if(s_iCnt5 >= 4)
    {
      ...
      if(cnt == 10){
        cnt = 0;
        OLEDClear();
        OLEDShowNum(8, 16, (100 - (int)(((76343 - total) / (76343 - 6900)) * 100)), 6, 16);
        OLEDShowChar(64, 16, '%', 16, 2);
        OLEDShowNum(8, 36, total / 10, 6, 16);
        OLEDShowString(64, 36, "us");
        OLEDRefreshGRAM();  
        total = 0;
      }
      s_iCnt5 = 0;
