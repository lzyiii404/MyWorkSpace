...
{   
  ...
  if(ScanKeyOne(KEY_NAME_KEY1, ProcKeyUpKey1, ProcKeyDownKey1)){
    mode = 1;
  }
  else if(ScanKeyOne(KEY_NAME_KEY2, ProcKeyUpKey2, ProcKeyDownKey2)){
    mode = 2;
  }
  else if(ScanKeyOne(KEY_NAME_KEY3, ProcKeyUpKey3, ProcKeyDownKey3)){
    mode = 1;
  }
