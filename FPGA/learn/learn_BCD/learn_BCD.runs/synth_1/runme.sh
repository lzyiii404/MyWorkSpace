...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn_BCD/learn_BCD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_counter_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BCD_counter_top.tcl
