...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn_BCD/learn_BCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BCD_counter_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BCD_counter_top.tcl -notrace
