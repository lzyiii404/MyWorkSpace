...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn3_8/learn3_8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log learn3_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source learn3_8.tcl
