...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn3_8/learn3_8.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log learn3_8.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source learn3_8.tcl -notrace
