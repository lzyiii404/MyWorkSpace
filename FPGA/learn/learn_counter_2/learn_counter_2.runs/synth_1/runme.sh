...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn_counter_2/learn_counter_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log module_counter_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source module_counter_test.tcl
