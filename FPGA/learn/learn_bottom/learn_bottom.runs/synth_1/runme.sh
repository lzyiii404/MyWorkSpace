...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn_bottom/learn_bottom.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log key_led_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source key_led_top.tcl
