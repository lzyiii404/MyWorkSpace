...
HD_PWD='D:/MyWorkSpace/FPGA/learn/learn_bottom/learn_bottom.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log key_led_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source key_led_top.tcl -notrace
