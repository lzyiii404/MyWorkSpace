...
HD_PWD='D:/MyWorkSpace/FPGA/learn/HXE8/HXE8.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex8_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex8_top.tcl
