...
#
# Generated by export_simulation on Mon Mar 30 20:29:07 +0800 2020
#
################################################################################
...
'-reset_run' switch to the './nexys4ddr_sys_clock_mmcm2.sh' script.

./nexys4ddr_sys_clock_mmcm2.sh -reset_run
...
./nexys4ddr_sys_clock_mmcm2.sh -noclean_files

For more information on the script, please type './nexys4ddr_sys_clock_mmcm2.sh -help'.
