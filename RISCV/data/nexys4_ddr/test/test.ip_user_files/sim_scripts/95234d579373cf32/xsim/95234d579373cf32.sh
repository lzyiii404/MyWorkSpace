...
#
# Generated by Vivado on Wed Apr 01 15:09:14 +0800 2020
# SW Build 2188600 on Wed Apr  4 18:40:38 MDT 2018
#
# Copyright 1986-2018 Xilinx, Inc. All Rights Reserved. 
#
# usage: 95234d579373cf32.sh [-help]
# usage: 95234d579373cf32.sh [-lib_map_path]
# usage: 95234d579373cf32.sh [-noclean_files]
# usage: 95234d579373cf32.sh [-reset_run]
#
#*********************************************************************************************************
...
# Script info
echo -e "95234d579373cf32.sh - Script generated by export_simulation (Vivado v2018.1 (64-bit)-id)\n"
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./95234d579373cf32.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb 95234d579373cf32.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./95234d579373cf32.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: 95234d579373cf32.sh [-help]\n\
Usage: 95234d579373cf32.sh [-lib_map_path]\n\
Usage: 95234d579373cf32.sh [-reset_run]\n\
Usage: 95234d579373cf32.sh [-noclean_files]\n\n\
