...
int main()
{
    ...
    for(int index = 1; index < 21; index++){
        char jpgName[64];
        sprintf(jpgName, "C:/Users/80944/Desktop/get/%d.jpg", index);
        if (_access(jpgName, 0) == -1){
            sprintf(jpgName, "C:/Users/80944/Desktop/get/%d.png", index);
        }
        //输入要识别的图片，并显示
        Mat srcImage = imread(jpgName, IMREAD_COLOR);
//        imshow("origin", srcImage);
        //对图像进行处理，转化为灰度图然后再转为二值图
//        srcImage = srcImage(Rect(50, 145, 390, 50));
        Mat grayImage;
        cvtColor(srcImage, grayImage, COLOR_BGR2GRAY);
//        imshow("cut", grayImage);
//        imwrite("C:/Users/80944/Desktop/cut.jpg", grayImage);
//        waitKey(0);
        Mat binImage;
...
//        imwrite("C:/Users/80944/Desktop/binary.jpg", binImage);
//        waitKey(0);
        ...
        {
            char name[64];
            sprintf(name, "C:/Users/80944/Desktop/number_recognition/number_recognition/image/%d.jpg", i);
