...
void sendRTInfo(void){
    ...
    switch (sendFlag){
        ...
        case 3:
            ...
            FloatToUnsignedchar(3,RT_Info.Height_V *100,DataToPC);
            FloatToUnsignedchar(7,Sensor_Info.FlowVelX *100 ,DataToPC);
            FloatToUnsignedchar(11,Sensor_Info.FlowVelY *100 ,DataToPC);
        ...
        case 4:
            ...
            FloatToUnsignedchar(3, RT_Info.FlowX_V *100  ,DataToPC);
            FloatToUnsignedchar(7, RT_Info.FlowY_V * 100 ,DataToPC);
            FloatToUnsignedchar(11,RT_Info.accZaxis *100 ,DataToPC);
