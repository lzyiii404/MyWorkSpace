...
execute()
{
  xrun $xrun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../AXI_GPIO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../AXI_GPIO.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../AXI_GPIO.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../AXI_GPIO.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../AXI_GPIO.srcs/sources_1/bd/system/ip/system_processing_system7_0_0" \
