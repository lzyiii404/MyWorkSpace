...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../LWIP.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../LWIP.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../LWIP.srcs/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../LWIP.srcs/sources_1/bd/system/ipshared/70cf/hdl" \
       +incdir+"../../../../LWIP.srcs/sources_1/bd/system/ip/system_processing_system7_0_1" \
