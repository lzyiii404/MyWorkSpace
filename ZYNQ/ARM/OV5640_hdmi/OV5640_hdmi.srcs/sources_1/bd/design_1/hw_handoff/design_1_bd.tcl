...
proc create_root_design { parentCell } {
  ...
  set cmos1_2c [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 cmos1_2c ]
  set cmos_rstn [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 cmos_rstn ]

  # Create ports
  set cmos_d_0 [ create_bd_port -dir I -from 9 -to 0 cmos_d_0 ]
  ...
  connect_bd_intf_net -intf_net processing_system7_0_IIC_0 [get_bd_intf_ports cmos1_2c] [get_bd_intf_pins processing_system7_0/IIC_0]
  ...
  connect_bd_net -net cmos_d_0_1 [get_bd_ports cmos_d_0] [get_bd_pins alinx_ov5640_0/cmos_d]
  connect_bd_net -net cmos_href_0_1 [get_bd_ports cmos_href_0] [get_bd_pins alinx_ov5640_0/cmos_href]
  connect_bd_net -net cmos_pclk_0_1 [get_bd_ports cmos_pclk_0] [get_bd_pins alinx_ov5640_0/cmos_pclk]
  connect_bd_net -net cmos_vsync_0_1 [get_bd_ports cmos_vsync_0] [get_bd_pins alinx_ov5640_0/cmos_vsync]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins alinx_ov5640_0/m_axis_video_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_1/m_axi_s2mm_aclk] [get_bd_pins axi_vdma_1/s_axis_s2mm_aclk] [get_bd_pins axis_subset_converter_0/aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins rst_ps7_0_142M/slowest_sync_clk] [get_bd_pins v_axi4s_vid_out_0/aclk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_dynclk_0/s00_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axi_vdma_1/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins v_tc_0/s_axi_aresetn]
  connect_bd_net -net rst_ps7_0_142M_peripheral_aresetn [get_bd_pins alinx_ov5640_0/m_axis_video_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins rst_ps7_0_142M/peripheral_aresetn]
  connect_bd_net -net v_tc_0_irq [get_bd_pins v_tc_0/irq] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axis_subset_converter_0/aresetn] [get_bd_pins xlconcat_1/dout]
