...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/model_ov5640_dual/ov5640_dual.runs/system_axis_subset_converter_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axis_subset_converter_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axis_subset_converter_0_3.tcl
