...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/model_ov5640_dual/ov5640_dual.runs/system_rst_processing_system7_0_140M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_processing_system7_0_140M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_processing_system7_0_140M_0.tcl
