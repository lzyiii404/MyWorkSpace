...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/model_ov5640_dual/ov5640_dual.runs/system_axi_vdma_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_axi_vdma_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_axi_vdma_0_1.tcl
