...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/model_ov5640_dual/ov5640_dual.runs/system_v_osd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_v_osd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_v_osd_0_0.tcl
