...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/VDMA_HDMI/VDMA_HDMI.runs/system_rst_ps7_0_142M_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_rst_ps7_0_142M_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_rst_ps7_0_142M_1.tcl
