...
simulate()
{
  xsim system -key {Behavioral:sim_1:Functional:system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_45a3.protoinst" -protoinst "protoinst_files/system.protoinst" -log simulate.log
}
