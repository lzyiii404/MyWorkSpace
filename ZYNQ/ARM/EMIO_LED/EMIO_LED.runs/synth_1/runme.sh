...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/EMIO_LED/EMIO_LED.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_embedded_system_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_embedded_system_wrapper.tcl
