...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/EMIO_LED/EMIO_LED.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_embedded_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zynq_embedded_system_wrapper.tcl -notrace
