...
HD_PWD='D:/MyWorkSpace/ZYNQ/ARM/EMIO_LED/EMIO_LED.runs/zynq_embedded_system_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_embedded_system_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_embedded_system_processing_system7_0_0.tcl
