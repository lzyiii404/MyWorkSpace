...
//Date        : Tue Sep 22 19:44:19 2020
//Host        : Huang running 64-bit major release  (build 9200)
//Command     : generate_target zynq_embedded_system.bd
//Design      : zynq_embedded_system
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "zynq_embedded_system,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=zynq_embedded_system,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "zynq_embedded_system.hwdef" *) 
module zynq_embedded_system
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
    DDR_0_ck_n,
  ...
  zynq_embedded_system_processing_system7_0_0 processing_system7_0
