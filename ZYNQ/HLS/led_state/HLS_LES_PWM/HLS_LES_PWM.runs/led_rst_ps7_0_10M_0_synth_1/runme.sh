...
HD_PWD='D:/MyWorkSpace/ZYNQ/HLS/led_state/HLS_LES_PWM/HLS_LES_PWM.runs/led_rst_ps7_0_10M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_rst_ps7_0_10M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_rst_ps7_0_10M_0.tcl
