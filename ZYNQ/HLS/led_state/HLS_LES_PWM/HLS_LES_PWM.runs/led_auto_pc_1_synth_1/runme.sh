...
HD_PWD='D:/MyWorkSpace/ZYNQ/HLS/led_state/HLS_LES_PWM/HLS_LES_PWM.runs/led_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_auto_pc_1.tcl
