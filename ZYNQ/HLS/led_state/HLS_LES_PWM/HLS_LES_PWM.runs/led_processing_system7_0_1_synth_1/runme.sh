...
HD_PWD='D:/MyWorkSpace/ZYNQ/HLS/led_state/HLS_LES_PWM/HLS_LES_PWM.runs/led_processing_system7_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_processing_system7_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_processing_system7_0_1.tcl
