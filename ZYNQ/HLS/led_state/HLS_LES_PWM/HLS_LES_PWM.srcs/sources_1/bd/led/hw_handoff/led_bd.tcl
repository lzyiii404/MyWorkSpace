...
################################################################
# This is a generated script based on design: led
#
...
proc create_root_design { parentCell } {
  ...
  # Create instance: led_state_0, and set properties
  set led_state_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:led_state:1.0 led_state_0 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR1 {12} \
  ...
  connect_bd_net -net rst_ps7_0_10M_peripheral_aresetn [get_bd_pins led_state_0/ap_rst_n] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_10M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_state_0/s_axi_AXILiteS/Reg] SEG_led_state_0_Reg
