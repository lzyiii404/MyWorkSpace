...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 total_cnt W 0x0 "Data signal of total_cnt" {{0 32 total_cnt W 0 "Bit 31 to 0 Data signal of total_cnt"}}} {0x18 high_cnt W 0x0 "Data signal of high_cnt" {{0 32 high_cnt W 0 "Bit 31 to 0 Data signal of high_cnt"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
