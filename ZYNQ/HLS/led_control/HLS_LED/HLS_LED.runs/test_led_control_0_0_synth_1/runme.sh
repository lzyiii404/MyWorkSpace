...
HD_PWD='D:/MyWorkSpace/ZYNQ/HLS/led_control/HLS_LED/HLS_LED.runs/test_led_control_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_led_control_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_led_control_0_0.tcl
