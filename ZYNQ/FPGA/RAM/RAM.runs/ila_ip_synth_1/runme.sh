...
HD_PWD='D:/MyWorkSpace/ZYNQ/FPGA/RAM/RAM.runs/ila_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_ip.tcl
