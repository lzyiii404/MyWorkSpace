...
HD_PWD='D:/MyWorkSpace/ZYNQ/FPGA/key/key.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_key_add_sub.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_key_add_sub.tcl -notrace
