...
HD_PWD='D:/MyWorkSpace/ZYNQ/FPGA/key/key.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_key_add_sub.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_key_add_sub.tcl
