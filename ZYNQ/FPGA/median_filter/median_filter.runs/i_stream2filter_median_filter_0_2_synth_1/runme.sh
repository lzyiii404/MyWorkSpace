...
HD_PWD='D:/MyWorkSpace/ZYNQ/FPGA/median_filter/median_filter.runs/i_stream2filter_median_filter_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i_stream2filter_median_filter_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i_stream2filter_median_filter_0_2.tcl
