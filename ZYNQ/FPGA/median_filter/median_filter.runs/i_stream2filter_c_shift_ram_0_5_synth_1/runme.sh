...
HD_PWD='D:/MyWorkSpace/ZYNQ/FPGA/median_filter/median_filter.runs/i_stream2filter_c_shift_ram_0_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i_stream2filter_c_shift_ram_0_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i_stream2filter_c_shift_ram_0_5.tcl
