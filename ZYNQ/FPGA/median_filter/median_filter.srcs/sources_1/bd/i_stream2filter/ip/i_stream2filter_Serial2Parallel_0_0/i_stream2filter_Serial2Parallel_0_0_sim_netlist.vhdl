...
-- Date        : Mon Nov 23 11:27:26 2020
-- Host        : Huang running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/MyWorkSpace/ZYNQ/FPGA/median_filter/median_filter.srcs/sources_1/bd/i_stream2filter/ip/i_stream2filter_Serial2Parallel_0_0/i_stream2filter_Serial2Parallel_0_0_sim_netlist.vhdl
...
entity i_stream2filter_Serial2Parallel_0_0_Serial2Parallel is
  port (
  ...
  attribute ORIG_REF_NAME of i_stream2filter_Serial2Parallel_0_0_Serial2Parallel : entity is "Serial2Parallel";
end i_stream2filter_Serial2Parallel_0_0_Serial2Parallel;

architecture STRUCTURE of i_stream2filter_Serial2Parallel_0_0_Serial2Parallel is
  signal \^o_data_2\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal \^o_data_3\ : STD_LOGIC_VECTOR ( 15 downto 0 );
  signal \tmp_data_1[15]_i_1_n_0\ : STD_LOGIC;
begin
  o_data_2(15 downto 0) <= \^o_data_2\(15 downto 0);
  o_data_3(15 downto 0) <= \^o_data_3\(15 downto 0);
\tmp_data_1[15]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity i_stream2filter_Serial2Parallel_0_0 is
  port (
    clk : in STD_LOGIC;
    rst_n : in STD_LOGIC;
    i_data : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute NotValidForBitStream of i_stream2filter_Serial2Parallel_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of i_stream2filter_Serial2Parallel_0_0 : entity is "i_stream2filter_Serial2Parallel_0_0,Serial2Parallel,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of i_stream2filter_Serial2Parallel_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of i_stream2filter_Serial2Parallel_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of i_stream2filter_Serial2Parallel_0_0 : entity is "Serial2Parallel,Vivado 2018.3";
end i_stream2filter_Serial2Parallel_0_0;

architecture STRUCTURE of i_stream2filter_Serial2Parallel_0_0 is
...
inst: entity work.i_stream2filter_Serial2Parallel_0_0_Serial2Parallel
     port map (
      clk => clk,
      i_data(15 downto 0) => i_data(15 downto 0),
      o_data_1(15 downto 0) => o_data_1(15 downto 0),
      o_data_2(15 downto 0) => o_data_2(15 downto 0),
      o_data_3(15 downto 0) => o_data_3(15 downto 0),
      rst_n => rst_n
    );
